      ...
      if(isset($_SESSION["mensagens_painel"])){
        if(count($_SESSION["mensagens_painel"])>0){
          for ($i=0; $i < count($_SESSION["mensagens_painel"]); $i++) { 
            echo "<div>".$_SESSION["mensagens_painel"][$i]["menssagem"]."</div>";
          }
        }
        unset($_SESSION["mensagens_painel"]);
      }
      ?>

      <form action="/painel/login" method="post">
        <div class="input-group mb-3">
          <input type="email" class="form-control" placeholder="Usuário" name="administradorEmail">
        ...
        <div class="input-group mb-3">
          <input type="password" class="form-control" placeholder="Senha" name="administradorSenha">
          <div class="input-group-append">
            <div class="input-group-text">
